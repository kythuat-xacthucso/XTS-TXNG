(function () {
    ...
    function viewEntityDetails(entityId) {
        ...
        window.adminLayout.loadContent('view-production-entity', { html: '../../pages/admin/production-entities/view/index.html' });
        history.pushState(null, '', `/view-production-entity?id=${entityId}`);
    }
    ...
    function editEntity(entityId) {
        ...
        history.pushState(null, '', `/edit-production-entity?id=${entityId}`);
    }
