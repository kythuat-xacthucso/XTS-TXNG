(function () {
    ...
    const payments = [
        { id: 1, code: "PAY001", customerName: "Nguyễn Văn A", amount: 1000000, createdAt: "2025-06-01 10:00", paidAt: "", approvedBy: "", status: "pending" },
        ...
        { id: 4, code: "PAY004", customerName: "Phạm Thị D", amount: 12000000, createdAt: "2025-06-04 11:00", paidAt: "", approvedBy: "", status: "pending" },
        ...
        { id: 7, code: "PAY007", customerName: "Đinh Văn G", amount: 2000000, createdAt: "2025-06-07 09:00", paidAt: "", approvedBy: "", status: "pending" },
        ...
        { id: 10, code: "PAY010", customerName: "Lý Thị K", amount: 18000000, createdAt: "2025-06-10 11:15", paidAt: "", approvedBy: "", status: "pending" },
        ...
        { id: 12, code: "PAY012", customerName: "Nguyễn Thị M", amount: 4000000, createdAt: "2025-06-12 09:45", paidAt: "", approvedBy: "", status: "pending" },
    ...
    function renderTable(data) {
        ...
        paginatedData.forEach((payment, index) => {
            const statusText = payment.status === 'pending' ? 'Chưa thanh toán' : payment.status === 'awaiting' ? 'Đã thanh toán' : 'Đã duyệt';
            const statusClass = payment.status === 'pending' ? 'bg-warning' : payment.status === 'awaiting' ? 'bg-success' : 'bg-primary';
            const row = `
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            ${payment.status === 'awaiting' ? `
                                <button class="btn btn-outline-success btn-sm" onclick="approvePayment(${payment.id})">
        ...
        paginatedData.forEach(payment => {
            ...
            const card = `
                <div class="col-12 payment-card">
                    ...
                    <p class="card-text">Tên khách hàng: ${payment.customerName}</p>
    ...
    function viewPaymentDetails(paymentId) {
        // Map 'paid' status to 'awaiting' for compatibility with view-order-payment
        ...
        // Update status to match view-order-payment
        payment.status = payment.status === 'paid' ? 'awaiting' : payment.status;

        // Navigate to view-order-payment with paymentId as query parameter
    ...
    function approvePayment(paymentId) {
        ...
        if (!payment || payment.status !== 'awaiting') {
            window.adminLayout.showNotification('Không thể duyệt thanh toán', 'danger');
            return;
        }
        ...
        const confirmHandler = () => {
            ...
            payment.approvedBy = 'Admin'; // Giả lập người duyệt
            applyFilters();
            modal.hide();
